...
number_of_epochs = 15
learning_rate = 0.02
number_of_layers_list = [6]  # number_of_hidden_layers
number_of_neurons_list = [340]  # number_of_neurons_in_each_hidden_layer

var_device = "cpu"

if __name__ == '__main__':
    for test_number in range(len(number_of_layers_list)):
        print("Test number: " + str(test_number))
        start_time = time.time()

        number_of_layers = number_of_layers_list[test_number]
        number_of_neurons = number_of_layers_list[test_number]
        ...
        predictions = torch.Tensor(predictions).to(var_device)
        trainAcc = torch.Tensor(trainAcc).to(var_device)
        testAcc = torch.Tensor(testAcc).to(var_device)
...
# plt.scatter(x1, execution_time_on_cpu, label='CPU')
# plt.legend()
# plt.show()
...
# plt.ylabel("Accuracy")
# plt.xlabel("Test number")
# plt.scatter(x1, accuracy, label='errors %')
# plt.legend()
# plt.show()
